...
class StatementImportConfirmationRowReceipt(P24Model):
    row_id: UUID
    resolution: str
...
class StatementImportConfirmReceipt(P24Model):
    ...
    row_results: list[StatementImportConfirmationRowReceipt] = Field(
        default_factory=lambda: list[StatementImportConfirmationRowReceipt]()
    )
    created_count: int = 0
    matched_count: int = 0
    skipped_count: int = 0
    result_detail_status: Literal["complete", "legacy_unavailable"] = "legacy_unavailable"
    replay: bool
