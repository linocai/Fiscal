...
未完成 Automated 门：iOS 分页/409/partial/receipt UI tests；fresh PG full、macOS regression、Kurisu 真机合成 fixture、VoiceOver/Dynamic Type/rotation/memory 与所有 production 门。
