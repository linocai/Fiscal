...
- backend ruff/pyright → 0 errors；Attention+P24/P27/P28 PostgreSQL targeted → **15 passed**；fresh PostgreSQL full JUnit → **269 tests, 0 failures, 0 errors, 0 skipped**。macOS Swift tests → **121 tests / 21 suites passed**；macOS+iOS Simulator Debug builds 均通过。
