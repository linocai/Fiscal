...
> 计划版本：v0.4（施工权威版）
> 日期：2026-07-17
> 状态：P17 v1.2.1 信用账期、现金流与交易分期统一施工中
...
- [2026-07-18] P17 本地施工与验证完成：后端账期模式/规则重算、只读信用现金流、原子分期消费及迁移 `20260718_0015` 已落地；Apple 双端完成分期录入、账期预览确认、查看账期/去还款和刷新代次保护；Ruff/Pyright/136 项默认测试、34 项相关 PostgreSQL 测试、81 项 Swift 测试、双端 Debug 与签名 Release 均通过。生产与装机证据待补入 `docs/qa/p17/results.md`。
