...
Fiscal is a private, single-user personal-finance application for iOS 26 and macOS 26. Its canonical CNY ledger covers accounts, credit cycles, installments, reimbursements, reports, AI/OCR capture, and manually reviewed PDF statement imports. Release `v2.2.0 (40)` is signed, installed locally on macOS, and available as a development-signed iOS IPA for operator installation. Product scope and the current stop point live in [`PROJECT_PLAN.md`](PROJECT_PLAN.md); release manifests live under [`archive/releases/`](archive/releases/).
...
- Current signed release and local-install manifest: [`archive/releases/v2.2.0/RELEASE_STATE.md`](archive/releases/v2.2.0/RELEASE_STATE.md).
- Prior signed release: [`archive/releases/v2.1.0/RELEASE_STATE.md`](archive/releases/v2.1.0/RELEASE_STATE.md).
