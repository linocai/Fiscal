...
public struct V15PeriodReport: Codable, Sendable {
    public struct Summary: Codable, Sendable {
        public let incomeMinor: V15MinorUnits; public let grossConsumptionMinor: V15MinorUnits; public let merchantRefundMinor: V15MinorUnits; public let netConsumptionMinor: V15MinorUnits; public let expectedReimbursementMinor: V15MinorUnits; public let receivedReimbursementMinor: V15MinorUnits; public let personalExpectedMinor: V15MinorUnits; public let personalRealizedMinor: V15MinorUnits; public let netIncomeExpenseMinor: V15MinorUnits; public let cashInflowMinor: V15MinorUnits; public let cashOutflowMinor: V15MinorUnits; public let cashNetMinor: V15MinorUnits; public let internalTransferInflowMinor: V15MinorUnits; public let internalTransferOutflowMinor: V15MinorUnits; public let creditDebtAtPeriodEndMinor: V15MinorUnits?; public let creditDebtAtPeriodEndStatus: String?; public let unknownBalanceAccountIDs: [UUID]?; public let balanceUnavailableReason: String?; public let reimbursementOutstandingAtPeriodEndMinor: V15MinorUnits
        enum CodingKeys: String, CodingKey { case creditDebtAtPeriodEndStatus = "credit_debt_at_period_end_status", unknownBalanceAccountIDs = "unknown_balance_account_ids", balanceUnavailableReason = "balance_unavailable_reason"; case incomeMinor = "income_minor", grossConsumptionMinor = "gross_consumption_minor", merchantRefundMinor = "merchant_refund_minor", netConsumptionMinor = "net_consumption_minor", expectedReimbursementMinor = "expected_reimbursement_minor", receivedReimbursementMinor = "received_reimbursement_minor", personalExpectedMinor = "personal_expected_minor", personalRealizedMinor = "personal_realized_minor", netIncomeExpenseMinor = "net_income_expense_minor", cashInflowMinor = "cash_inflow_minor", cashOutflowMinor = "cash_outflow_minor", cashNetMinor = "cash_net_minor", internalTransferInflowMinor = "internal_transfer_inflow_minor", internalTransferOutflowMinor = "internal_transfer_outflow_minor", creditDebtAtPeriodEndMinor = "credit_debt_at_period_end_minor", reimbursementOutstandingAtPeriodEndMinor = "reimbursement_outstanding_at_period_end_minor" }
    }
    public struct Account: Codable, Sendable { public let accountID: UUID; public let accountName: String; public let accountKind: V15ReportAccountKind; public let openingBalanceMinor: V15MinorUnits?; public let openingBalanceStatus: String?; public let closingBalanceStatus: String?; public let balanceAsOfDate: String?; public let balanceUnavailableReason: String?; public let closingBalanceMinor: V15MinorUnits?; public let periodInflowMinor: V15MinorUnits; public let periodOutflowMinor: V15MinorUnits; public let internalTransferInflowMinor: V15MinorUnits; public let internalTransferOutflowMinor: V15MinorUnits; enum CodingKeys: String, CodingKey { case openingBalanceStatus = "opening_balance_status", closingBalanceStatus = "closing_balance_status", balanceAsOfDate = "balance_as_of_date", balanceUnavailableReason = "balance_unavailable_reason"; case accountID = "account_id", accountName = "account_name", accountKind = "account_kind", openingBalanceMinor = "opening_balance_minor", closingBalanceMinor = "closing_balance_minor", periodInflowMinor = "period_inflow_minor", periodOutflowMinor = "period_outflow_minor", internalTransferInflowMinor = "internal_transfer_inflow_minor", internalTransferOutflowMinor = "internal_transfer_outflow_minor" } }
...
public enum V15ReportTransactionKind: Sendable, Equatable, Codable { case income, expense, transfer, creditPurchase, repayment, borrowing, loanPrincipal, creditPrincipalWaiver, creditFeeRefund, creditSettlementFee, installmentFee, installmentRefund, reimbursementReceipt, unknown(String)
    public init(from decoder: Decoder) throws { switch try decoder.singleValueContainer().decode(String.self) { case "income": self = .income; case "expense": self = .expense; case "transfer": self = .transfer; case "credit_purchase": self = .creditPurchase; case "repayment": self = .repayment; case "borrowing": self = .borrowing; case "loan_principal": self = .loanPrincipal; case "credit_principal_waiver": self = .creditPrincipalWaiver; case "credit_fee_refund": self = .creditFeeRefund; case "credit_settlement_fee": self = .creditSettlementFee; case "installment_fee": self = .installmentFee; case "installment_refund": self = .installmentRefund; case "reimbursement_receipt": self = .reimbursementReceipt; case let raw: self = .unknown(raw) } }
    public func encode(to encoder: Encoder) throws { var container = encoder.singleValueContainer(); try container.encode(rawValue) }
    public var rawValue: String { switch self { case .income: "income"; case .expense: "expense"; case .transfer: "transfer"; case .creditPurchase: "credit_purchase"; case .repayment: "repayment"; case .borrowing: "borrowing"; case .loanPrincipal: "loan_principal"; case .creditPrincipalWaiver: "credit_principal_waiver"; case .creditFeeRefund: "credit_fee_refund"; case .creditSettlementFee: "credit_settlement_fee"; case .installmentFee: "installment_fee"; case .installmentRefund: "installment_refund"; case .reimbursementReceipt: "reimbursement_receipt"; case .unknown(let raw): raw } }
}
...
public struct V15StatementProviderAuthorization: Codable, Sendable, Equatable { public let configurationRevision: String?; public let confirmed: Bool; public let provider: String; public let providerModel: String; public let promptVersion: String; public let schemaVersion: String; public let evidenceSHA256: String; public let pageNumbers: [Int]; public let rowCount: Int; public let redactionVersion: String; public let redactionCount: Int; public init(confirmed: Bool, provider: String, providerModel: String, promptVersion: String, schemaVersion: String, evidenceSHA256: String, pageNumbers: [Int], rowCount: Int, redactionVersion: String, redactionCount: Int, configurationRevision: String? = nil) { self.configurationRevision = configurationRevision; self.confirmed = confirmed; self.provider = provider; self.providerModel = providerModel; self.promptVersion = promptVersion; self.schemaVersion = schemaVersion; self.evidenceSHA256 = evidenceSHA256; self.pageNumbers = pageNumbers; self.rowCount = rowCount; self.redactionVersion = redactionVersion; self.redactionCount = redactionCount }; enum CodingKeys: String, CodingKey { case configurationRevision = "configuration_revision"; case confirmed, provider, providerModel = "provider_model", promptVersion = "prompt_version", schemaVersion = "schema_version", evidenceSHA256 = "evidence_sha256", pageNumbers = "page_numbers", rowCount = "row_count", redactionVersion = "redaction_version", redactionCount = "redaction_count" } }
...
public struct V15StatementProviderAttempt: Decodable, Sendable, Equatable {
    ...
    public let batch: V15StatementImport
    enum CodingKeys: String, CodingKey { case providerAttemptID = "provider_attempt_id", attemptID = "attempt_id", providerStatus = "provider_status", candidateCount = "candidate_count", replay, executionScope = "execution_scope", providerSnapshotID = "provider_snapshot_id" }
    public init(from decoder: Decoder) throws {
        let c = try decoder.container(keyedBy: CodingKeys.self)
        providerAttemptID = try c.decode(String.self, forKey: .providerAttemptID)
        attemptID = try c.decode(String.self, forKey: .attemptID)
        providerStatus = try c.decode(String.self, forKey: .providerStatus)
        candidateCount = try c.decode(Int.self, forKey: .candidateCount)
        replay = try c.decode(Bool.self, forKey: .replay)
        executionScope = try c.decode(String.self, forKey: .executionScope)
        providerSnapshotID = try c.decodeIfPresent(UUID.self, forKey: .providerSnapshotID)
        batch = try V15StatementImport(from: decoder)
    }
    public var isRequestBound: Bool { executionScope == "request_bound" }
}

public struct V15StatementProviderAuthorizationPreview: Codable, Sendable, Equatable {
    public let batchVersion: Int; public let configured: Bool
    public let provider: String?; public let providerModel: String?; public let promptVersion: String?; public let schemaVersion: String?; public let configurationRevision: String?
    public let evidenceSHA256: String?; public let pageNumbers: [Int]; public let rowCount: Int; public let redactionCount: Int; public let redactionVersion: String; public let description: String
    enum CodingKeys: String, CodingKey { case configured, provider, description, batchVersion = "batch_version", providerModel = "provider_model", promptVersion = "prompt_version", schemaVersion = "schema_version", configurationRevision = "configuration_revision", evidenceSHA256 = "evidence_sha256", pageNumbers = "page_numbers", rowCount = "row_count", redactionCount = "redaction_count", redactionVersion = "redaction_version" }
}
public struct V15StatementRecovery: Decodable, Sendable, Equatable {
    public let batch: V15StatementImport; public let nextAction: String; public let evidenceSHA256: String?; public let rowCount: Int
    public let activeAttemptID: UUID?; public let providerAttemptID: UUID?; public let providerStatus: String?; public let providerSnapshotID: UUID?; public let validationRunID: UUID?
    public let hasConfirmedRows: Bool; public let confirmationStatus: String?; public let failureReason: String?
    enum CodingKeys: String, CodingKey { case batch, nextAction = "next_action", evidenceSHA256 = "evidence_sha256", rowCount = "row_count", activeAttemptID = "active_attempt_id", providerAttemptID = "provider_attempt_id", providerStatus = "provider_status", providerSnapshotID = "provider_snapshot_id", validationRunID = "validation_run_id", hasConfirmedRows = "has_confirmed_rows", confirmationStatus = "confirmation_status", failureReason = "failure_reason" }
}
...
public enum V15LedgerReadKind: String, Codable, CaseIterable, Sendable, Equatable, Identifiable {
    ...
    public var id: String { rawValue }
    public var displayName: String { switch self { case .income: "收入"; case .expense: "支出"; case .transfer: "转账"; case .creditPurchase: "信用卡消费"; case .borrowing: "借入"; case .repayment: "还款"; case .loanPrincipal: "贷款本金确认"; case .creditPrincipalWaiver: "本金减免"; case .creditFeeRefund: "费用减免"; case .creditSettlementFee: "结清手续费"; case .installmentFee: "分期手续费"; case .installmentRefund: "分期退款"; case .reimbursementReceipt: "报销回款" } }
}
