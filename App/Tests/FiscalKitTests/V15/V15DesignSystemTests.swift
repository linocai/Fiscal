...
struct V15DesignSystemTests {
    ...
    func paletteValues() {
        ...
        #expect(V15Palette.positive == .init(lightHex: 0x16765C, darkHex: 0x63D2A9))
        #expect(V15Palette.warning == .init(lightHex: 0x9A6800, darkHex: 0xF1C45E))
        #expect(V15Palette.provisional == .init(lightHex: 0xF3F1EA, darkHex: 0x202624))
        #expect(V15Palette.unknown == .init(lightHex: 0x66568F, darkHex: 0xC7B8F5))
        ...
        #expect(V15Palette.receipt == .init(lightHex: 0xE5F5EE, darkHex: 0x123126))
    }
    ...
    func outcomeUnknownVisualContract() {
        ...
        #expect(unknown.marker == V15Palette.unknown)
        #expect(unknown.background == V15Palette.unknownSurface)
