...
- [x] `archive/releases/v1.0-v1.3/qa/p1/screenshots/ios-overview.png` exists.
- [x] `archive/releases/v1.0-v1.3/qa/p1/screenshots/macos-overview.png` exists.
- [ ] Narrow/long-content evidence is retained where useful.
- [x] Screenshots were compared manually with `archive/design/prototype-v1/`.
