...
| Candidate app version before P20-B | `App/project.yml` | `1.2.4 (20)` |
...
`archive/releases/v1.0-v1.3/qa/p19/results.md` records a 2026-07-19 transition deployment at
...
- P20-B release state source / version: complete locally. `README.md` is an
  entrypoint, `archive/releases/v1.4.0/RELEASE_STATE.md` is the compact current manifest, and the
...
| Gate | Result |
| --- | --- |
| `cd App && xcodegen generate` | passed; generated project carries `MARKETING_VERSION=1.3.0`, `CURRENT_PROJECT_VERSION=21` |
| `xcodebuild -project App/Fiscal.xcodeproj -scheme FiscalmacOS -destination 'platform=macOS' test -only-testing:FiscalKitTests` | passed: 88 tests in 17 suites |
