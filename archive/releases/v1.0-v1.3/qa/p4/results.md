...
- Project generation: `xcodegen generate --spec App/project.yml` passed.
- iOS 26 build passed.
...
Evidence is retained under `archive/releases/v1.0-v1.3/qa/p4/screenshots/`:
