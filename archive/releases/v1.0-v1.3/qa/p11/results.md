...
P12 production migration completed after this P11 baseline: 148 target objects were created, an identical replay was a no-op, and both 38-check reconciliations had zero mismatches. See `archive/releases/v1.0-v1.3/qa/p12/results.md`.
