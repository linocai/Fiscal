...
```sh
Backend/ops/production/scripts/p12-shadow-drill.sh \
...
```sh
python3 -m unittest Backend/ops/production/tests/test_p12_shadow_drill.py
bash -n Backend/ops/production/scripts/p12-shadow-drill.sh
```
