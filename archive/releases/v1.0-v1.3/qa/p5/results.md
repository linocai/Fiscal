...
The evidence was reviewed against `archive/design/prototype-v1`: future installment values are presented as contractual scheduled amounts, not exact repayment balances, and no projected installment is inserted into cash-flow totals.
