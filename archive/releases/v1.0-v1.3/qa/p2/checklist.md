...
- [x] iOS and macOS screenshots are retained under `archive/releases/v1.0-v1.3/qa/p2/screenshots/`.
- [x] All commands and results are recorded in `archive/releases/v1.0-v1.3/qa/p2/results.md`.
