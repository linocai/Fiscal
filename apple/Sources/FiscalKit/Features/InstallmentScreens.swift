...
public struct IOSInstallmentPlanDetail: View {
    ...
    @ViewBuilder private var stateView: some View { switch installments.phase { case .unauthorized: retryState("访问口令无效", "key"); case .offline: retryState("无法连接个人 VPS", "wifi.slash"); case .failed: retryState("分期读取失败", "exclamationmark.triangle"); default: ProgressView("正在读取分期…") } }
